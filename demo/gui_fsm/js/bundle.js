...
},{"lodash":99}],99:[function(require,module,exports){
(function (global){
/**
 * @license
...
exports['default'] = {
    load: function load(appId) {
        ...
        return fetch('./templates/signIn.html').then(function (resp) {
            return resp.text();
        }).then(function (tmpl) {
            template = tmpl;
    ...
    bindEvents: function bindEvents(FSM) {
        return new Promise(function (resolve, reject) {
            handleSignIn(FSM);
            resolve(true);
        });
...
function handleSignIn(FSM) {
    ...
    dom('#sign-in-phone').on('click', function () {
        var login = dom('#login').val();
        var passw = dom('#password').val();
        model.login = login;
        model.passw = passw;
...
},{"mustache":100,"whatwg-fetch":101}],103:[function(require,module,exports){
'use strict';
...
exports['default'] = {
    load: function load(appId) {
        ...
        return fetch('./templates/signUp.html').then(function (resp) {
            return resp.text();
        }).then(function (tmpl) {
    ...
    bindEvents: function bindEvents(FSM) {
        return new Promise(function (resolve, reject) {
            document.getElementById('sign-up-back').addEventListener('click', FSM.goBack.bind(FSM));

            document.getElementById('sign-up-vk').addEventListener('click', FSM.showSignVK.bind(FSM));

            document.getElementById('sign-up-fb').addEventListener('click', FSM.showSignFB.bind(FSM));

            document.getElementById('sign-up-phone').addEventListener('click', FSM.showSignPhone.bind(FSM));
...
},{"mustache":100,"whatwg-fetch":101}],104:[function(require,module,exports){
'use strict';
...
exports['default'] = {
    load: function load(appId) {
        ...
        return fetch('./templates/teaser.html').then(function (resp) {
            return resp.text();
        }).then(function (tmpl) {
            var rendered = Mustache.render(tmpl, view);
            document.getElementById('app').innerHTML = rendered;
    ...
    bindEvents: function bindEvents(FSM) {
        return new Promise(function (resolve, reject) {
            document.getElementById('sign-in').addEventListener('click', FSM.showSignIn.bind(FSM));

            document.getElementById('sign-up').addEventListener('click', FSM.showSignUp.bind(FSM));
...
},{"mustache":100,"whatwg-fetch":101}],105:[function(require,module,exports){
'use strict';
...
var _formsTeaser = require('./forms/teaser');

var teaserForm = _interopRequireWildcard(_formsTeaser);

var _formsSignIn = require('./forms/signIn');

var signInForm = _interopRequireWildcard(_formsSignIn);

var _formsSignUp = require('./forms/signUp');

var signUpForm = _interopRequireWildcard(_formsSignUp);
...
function loadAndGoto(formID, nextState) {
    return function () {
        ...
        FORMS[formID].load().then(this.transition.bind(this, nextState))['catch'](this.showError.bind(this));
    };
}
...
function bindAndWait(formID) {
    return function () {
        ...
        FORMS[formID].bindEvents(FSM).then(this.deferUntilTransition.bind(this))['catch'](this.showError.bind(this));
    };
}
...
},{"./forms/signIn":102,"./forms/signUp":103,"./forms/teaser":104,"front-log":97,"machina":98}],106:[function(require,module,exports){
'use strict';
...
},{"./fsm":105,"babel/polyfill":93,"baconjs":94,"domready":96}]},{},[106])
